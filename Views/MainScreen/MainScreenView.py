...
class MainScreenView(tk.Frame):
    def __init__(self, parent, cont):
        ...
        logout_button = tk.Button(logout_frame, text="Çıkış Yap", command=lambda :cont.show_frame(Views.LoginScreenView))
        ...
        student_button = tk.Button(buttons_frame, text="Öğrenci Yönetimi", command=lambda: self.open_management_view(Views.STUDENT))
        employee_button = tk.Button(buttons_frame, text="Çalışan Yönetimi", command=lambda: self.open_management_view(Views.EMPLOYEE))
        course_button = tk.Button(buttons_frame, text="Ders Yönetimi", command=lambda: cont.show_frame(None))
        accounting_button = tk.Button(buttons_frame, text="Muhasebe", command=lambda: cont.show_frame(None))
        stock_button = tk.Button(buttons_frame, text="Stok Takibi", command=lambda: cont.show_frame(None))
        contact_button = tk.Button(buttons_frame, text="İletişim", command=lambda: cont.show_frame(None))
